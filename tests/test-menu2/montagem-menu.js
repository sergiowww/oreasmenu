...
MenuBar.menuBar6 = function() {
	...
	factorymenuBar.addNivel(new Nivel(Nivel.ORIENTACAO_HORIZONTAL, "menuNivel1", "menuNivel1-Hover", null, 120, 22, Nivel.TAMANHO_EM_PX, false, Nivel.NAO_EXPANDIR_SUBNIVEL));
	factorymenuBar.addNivel(new Nivel(Nivel.ORIENTACAO_HORIZONTAL, "menuNivel2", "menuNivel2-Hover", null, null, null, Nivel.TAMANHO_EM_PX, false, Nivel.NAO_EXPANDIR_SUBNIVEL));
